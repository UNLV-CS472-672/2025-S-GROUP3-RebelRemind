 ...
 *			     (from locale or machine) and displays a calendar based on the week.
 * Uses: react-big-calendar to display and format the calendar
 *	 date-fns for reading and parsing the date from the locale.
 *
 * Features:
 * - Selecting "Weekly Reminders" places a Calendar object into the extension,
 *   and renders a Week-Only view of the calendar. Should display assignments and events from backend (TBD).
 *
 * Components:
